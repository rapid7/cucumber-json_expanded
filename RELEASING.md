...
- [ ] Add an item to each category's list in the following format: `[#<PR>](https://github.com/rapid7/cucumber-json_expanded/pull/<PR>) <consumer summary> - [@<github_user>](https://github.com/<github_user>)`
...
increment [`PATCH`](lib/cucumber/json_expanded/version.rb).
...
1. To remain pre-1..0.0, then increment [`MINOR`](lib/cucumber/json_expanded/version.rb) and reset [`PATCH`](lib/cucumber/json_expanded/version.rb) to `0`.
2. To advance to 1.0.0, increment [`MAJOR`](lib/cucumber/json_expanded/version.rb) and reset [`MINOR`](lib/cucumber/json_expanded/version.rb and [`PATCH`](lib/cucumber/json_expanded/version.rb) to `0`.
...
## jruby
- [ ] `rvm use jruby@cucumber-json_expanded`
- [ ] `rm Gemfile.lock`
- [ ] `bundle install`
- [ ] `rake release`

## ruby-2.1
- [ ] `rvm use ruby-2.1@cucumber-json_expanded`
- [ ] `rm Gemfile.lock`
- [ ] `bundle install`
- [ ] `rake release`
```
