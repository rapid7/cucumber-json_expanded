Feature: JSON output formatter
  ...
  Scenario: one feature, one passing scenario, one failing scenario
    When I run `cucumber --format Cucumber::JsonExpanded::Formatter features/one_passing_one_failing.feature`
  ...
  Scenario: DocString
    ...
    And a file named "features/step_definitions/doc_string_steps.rb" with:
      ...
      """
    When I run `cucumber --format Cucumber::JsonExpanded::Formatter features/doc_string.feature`
    Then it should fail with JSON:
      """
      [
        {
  ...
  Scenario: embedding screenshot
    When I run `cucumber -b --format Cucumber::JsonExpanded::Formatter features/embed.feature`
  ...
  Scenario: scenario outline
    When I run `cucumber --format Cucumber::JsonExpanded::Formatter features/outline.feature`
    Then it should fail with JSON:
    """
    [
      {
  ...
  Scenario: scenario outline expanded
    When I run `cucumber --expand --format Cucumber::JsonExpanded::Formatter features/outline.feature`
    Then it should fail with JSON:
    """
    [
      {
